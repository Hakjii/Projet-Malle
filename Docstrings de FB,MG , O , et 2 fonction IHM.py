...
def somme_a_donner_FB(somme_a_rendre):
    '''
La fonction somme_a_donner_FB permet de déterminer toutes les pièces et billets à rendre d'après une somme total
    '''
...
def somme_a_donner_MG(somme_a_rendre) :
    '''
La fonction somme_a_donner_MG permet de déterminer toutes les pièces et billets à rendre d'après une somme total
mais avec un nombre de pièces et billets limité 
    '''
...
def somme_a_donner_O(total_G, total_M, total_N):
    '''
La fonction somme_a_donner_O permet de rendre une somme d'argent en un minimum de pièces avec le systeme de monnaie suivant:
1 gallion égal à 17 mornilles et 1 mornille égal à 29 noises
    '''
...
def dico_resultat(sommes_a_rendre, magasin):
    '''
La fonction dico_resultat permet à l'utilisateur de choisir dans quel boutique il veut se rendre
    '''
...
def question_utilisateur():
    '''
La fonction question_utilisateur permet à l'utilisateur de choisir entre le résultat imposé et son propre résultat dabs la boutique sélectionné
et il va renvoyer le rendu de monnaie 
    '''
